...
// is converted from gopdf to complex content, and finally a gopdf file
// is generated.
...
// Generate gopdf files for text content from already saved atomicCells,
...
// Generate a gopdf file of the content recorded in atomicCells.
func (convert *Converter) Execute() {
	...
	for _, line := range lines {
		...
		switch elements[0] {
		case "P":
			convert.Page(line, elements) // gopdf start
		case "NP":
